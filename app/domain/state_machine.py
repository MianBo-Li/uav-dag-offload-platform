...
ALLOWED_TRANSITIONS: dict[State, set[State]] = {
    ...
    SubtaskStatus.WAITING: {SubtaskStatus.READY},
    SubtaskStatus.READY: {SubtaskStatus.DISPATCHED},
    SubtaskStatus.DISPATCHED: {SubtaskStatus.RUNNING},
    SubtaskStatus.RUNNING: {SubtaskStatus.SUCCESS, SubtaskStatus.FAILED},
    SubtaskStatus.FAILED: {SubtaskStatus.RETRYING},
    SubtaskStatus.RETRYING: {SubtaskStatus.READY},
